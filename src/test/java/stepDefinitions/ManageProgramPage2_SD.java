...
public class ManageProgramPage2_SD {
	...
	List<String> programNameDel;
	
	
	public ManageProgramPage2_SD(TestContext testContext) {
...
//	   testcontext.getPageObjectManager().getLoginPage().clickSubmit();
	...
	pagination.clickPage(pagination.getNextIcon());
	}

	@Then("Admin should see the Pagination has Next active link")
	public void admin_should_see_the_pagination_has_Next_active_link() {
	    pagination.isNextPageIconDisplayed();
	}
	...
	public void admin_clicks_first_page_link() {
	    pagination.clickPage(pagination.getFourthPage());
	}
	...
	public void admin_should_see_the_previous_page_record_on_the_table_with_pagination_has_previous_page_link() {
	    pagination.isThirdPageDisplayed();
	}

	@When("Admin clicks Start page link")
	public void admin_clicks_start_page_link() {
	    pagination.clickPage(pagination.getInitialPage());
	...
	public void admin_should_see_the_very_first_page_record_on_the_table_with_previous_page_link_are_disabled() {
	    pagination.isPreviousLinksDisabled();
	}
	...
	public void admin_clicks_delete_button_under_header_after_selecting_the_check_box_in_the_data_table() {
		try {
			manageProgramPage.clickSingleChkbox();
	...
	public void admin_should_land_on_manage_program_page_and_can_see_the_selected_program_is_deleted_from_the_data_table() {
		...
		boolean flag = false;
		try {
			flag = userSortingPage.verifyDeletedBatches(programNameDel);
		} catch (InterruptedException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	public void admin_should_land_on_manage_program_page_and_can_see_the_selected_program_is_not_deleted_from_the_data_table() {
		manageProgramPage.noButton().click();
		boolean flag = false;
		try {
			flag = userSortingPage.verifyDeletedBatches(programNameDel);
		} catch (InterruptedException e) {
	...
	public void admin_clicks_delete_button_under_header_after_selecting_multiple_checkboxes_in_the_data_table() {
		try {
			programNameDel = userSortingPage.selectMultipleCheckboxes();
		...
		userSortingPage.clickManageHeaderDeleteIconForMultipleRow();
		userSortingPage.clickYesButton();
	}
...
//		}
	...
	public void admin_should_land_on_manage_program_page_and_can_see_the_selected_programs_are_not_deleted_from_the_data_table() throws InterruptedException {
		programNameDel = userSortingPage.selectMultipleCheckboxesA();
		userSortingPage.clickManageHeaderDeleteIconForMultipleRow();
		manageProgramPage.noButton().click();
		boolean flag = false;
		try {
