...
|AddUser		 | 1    | Failed   | Existing value|
|AddUser		 | 2    | Failed   | Invalid data|
|AddUser		 | 3    | Failed   | Missing mandatory values|
|AddUser		 | 4    | Failed   | Missing mandatory values|
|AddUser		 | 5    | Failed   | Missing mandatory values|
|AddUser		 | 6    | Failed   | Missing mandatory values|
|AddUser		 | 7    | Failed   | Missing mandatory values|
|AddUser		 | 8    | Failed   | Missing mandatory values|
|AddUser		 | 9    | Failed   | Missing mandatory values|
